  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/assets/culture/cultureHero.svg')`,
          backgroundBlendMode: "overlay",
        }}
      >
        {/* Custom gradient overlay */}
        <div className="absolute inset-0 opacity-75 bg-gradient-to-r from-[#8F3F05] to-[#874313E3]/[37%]"></div>
      </div>
        ...
        <div className="container mx-auto px-6 md:px-12 ">
          <div className="max-w-[740px] ">
            ...
            <p className="text-lg md:text-[32px] font-[400] md:leading-[39px] text-white mb-8">
              At BLIP LLC we believe that exceptional performance is only
              possible with exceptional people
            </p>
