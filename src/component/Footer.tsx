    ...
    <footer className="bg-[/112134] text-white py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Contact Information */}
          <div>
            <h4 className="text-[18px] font-[500] mb-4">For any other queries</h4>
            <ul className="space-y-2 text-sm font-light">
              <li className='text-[18px] font-[400] '>Reach us at info@blip.africa</li>
              <li className='text-[18px] font-[400] '>WhatsApp: +2348166178166</li>
